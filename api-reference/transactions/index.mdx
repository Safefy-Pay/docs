...
Quando voce informa `callbackUrl` na criacao, a Safefy envia webhooks de mudanca de status. Veja os detalhes em [Webhooks de transacao](/api-reference/transactions/webhooks).
