...
| `customerPhone` | Opcional | Opcional |
...
### Campo opcional: telefone do cliente

Você também pode enviar `customerPhone` para registrar o telefone do pagador quando criar a transação.

- Formatos aceitos: com máscara ou apenas dígitos
- Exemplos: `(11) 99999-9999`, `11999999999`
- A API normaliza automaticamente para dígitos
