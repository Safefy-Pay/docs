...
<Info>
A partir de agora, você também pode usar **cartão tokenizado** como forma de pagamento!

Consulte o guia dedicado: [Tokenizar cartão](/api-reference/transactions/card-tokenize).
</Info>
