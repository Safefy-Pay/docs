...
<ParamField body="customerId" type="string">
  ID do cliente associado à transação (UUID). Para boleto, é obrigatório informar **customerId ou customerName**.
</ParamField>

<ParamField body="customerName" type="string">
  Nome do cliente/pagador. Se `customerId` não for enviado e você informar `customerName`, a Safefy cria (ou reutiliza) um cliente automaticamente e vincula a transação.
</ParamField>

<ParamField body="customerDocument" type="string">
  CPF/CNPJ do cliente/pagador. Opcional.
</ParamField>

<ParamField body="customerEmail" type="string">
  Email do cliente/pagador. Opcional. Se não for enviado, a Safefy gera um email técnico apenas para viabilizar o processamento.
</ParamField>
